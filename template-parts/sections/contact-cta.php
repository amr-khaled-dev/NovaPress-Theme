    ...
    <div class="container">
        <div class="contact-cta-content">
            ...
            <div class="cta-actions">
                <a href="<?php echo esc_url($ctaPrimaryUrl); ?>" class="btn btn-outline"><?php echo esc_html($ctaPrimaryText); ?></a>
                <a href="<?php echo esc_url($ctaSecondaryUrl); ?>" class="btn"><?php echo esc_html($ctaSecondaryText); ?></a>
            </div>
        </div>
    </div>
</section>